...
privileged aspect CoordinateController_Roo_Controller {
    ...
    public String CoordinateController.create(@Valid Coordinate coordinate, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, coordinate);
    ...
    public String CoordinateController.createForm(Model uiModel) {
        populateEditForm(uiModel, new Coordinate());
        return "coordinates/create";
    }
    ...
    public String CoordinateController.update(@Valid Coordinate coordinate, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, coordinate);
    ...
    void CoordinateController.populateEditForm(Model uiModel, Coordinate coordinate) {
        uiModel.addAttribute("coordinate", coordinate);
    }
    
    String CoordinateController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
